...
export default class Department extends Component {
    ...
    deleteClick(id){
        if(window.confirm('Etes-vous sure de vouloir effectuer cette action?')){
    ...
    FilterList(){
        var departmentIdFilter=this.state.DepartmentFilter
        var DepartmentNameFilter=this.state.DepartmentNameFilter
        var filterDate = this.state.departmentWithoutFilter.filter(
            function(el){
        ...
        this.setState({departments:filterDate})

    }

    sortResult(props, asc){
        var sortedData = this.state.departmentWithoutFilter.sort((a,b)=>{
            if(asc){
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className='modal fade' id='exempleModal' tabIndex='-1' aria-hidden='true'>
                ...
                <div className='modal-content'>
                    ...
                    <div className='modal-body'>
                        <div className='input-group mb-3'>
                            ...
                            <input type='text' className='form-control' value={DepartmentName} onChange={ this.changeDepartmentName } placeholder='Enter DepartmentName' />
                        </div>
